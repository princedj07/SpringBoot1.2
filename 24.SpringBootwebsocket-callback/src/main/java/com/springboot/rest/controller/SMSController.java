...
import com.springboot.rest.domain.SMS;
import com.springboot.rest.service.SMSService;
...
public class SMSController {
    ...
    public void smsSubmit(@RequestBody SMS sms) {
        try{
        	System.out.println("SMSController.smsSubmit()");
            service.send(sms);
        }
    ...
    public void smsCallback(@RequestBody MultiValueMap<String, String> map) {
    	System.out.println("SMSController.smsCallback()");
       service.receive(map);
